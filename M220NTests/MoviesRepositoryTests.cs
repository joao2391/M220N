...
namespace M220NTests
{
    public class MoviesRepositoryTests
    {
        ...
        public async Task TestReturnsMoviesSortedByCustom()
        {
            ...
            Assert.AreEqual("Within Limits", movies.First().Title);
            Assert.AreEqual(2009, movies.First().Year);
            Assert.AreEqual("Winter Soldier", movies.Last().Title);
            Assert.AreEqual(1972, movies.Last().Year);
